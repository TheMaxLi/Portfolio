			...
			<div class="flex flex-col items-center">
				<div class="flex items-center justify-between max-md:flex-col max-md:space-x-0 max-md:pr-0">
					...
					<div class="mt-6 flex justify-center">
						<img src="/Harmony/MonthView.png" alt="Calendar Month View" class="w-7/12 shadow-lg" />
					</div>
				</div>
				<div
				...
				<div class="w-full space-y-6">
					<div class="rounded-lg bg-zinc-800 p-6">
						...
						<div class="grid grid-cols-1 gap-8 md:grid-cols-2">
							...
							<div>
								<h4 class="mb-2 text-sm uppercase tracking-wider text-zinc-400">Backend & Data</h4>
								<div class="mt-2 flex flex-wrap gap-2">
						...
						<div class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2">
							<div>
								<h4 class="mb-2 text-sm uppercase tracking-wider text-zinc-400">AI Integration</h4>
								<div class="mt-2 flex flex-wrap gap-2">
