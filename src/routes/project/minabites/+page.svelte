			...
			>
				...
				>
					<div class="space-y-5">
						...
						<p>
							Mina Bites is a restaurant discovery and planning app inspired by my love for
							exploring new dining experiences. It bridges the gap between finding great places to
							eat and planning meals with friends, creating a more social and organized approach to
							dining out.
						</p>
					</div>
				</div>
				...
				<div class="flex flex-col items-center">
					...
					>
						<div class="max-w-[700px] space-y-4">
							...
							<p>
								The group recommendations feature allows users to share and vote on restaurant
								options with friends. It simplifies the process of deciding where to eat by
								collecting everyone's preferences in one place and highlighting top choices.
							</p>
						</div>
						<div class="mt-6 flex justify-center">
							<img
